(function() {
  ...
  Gretel.prototype.updateLocation = function(position) {
    this.geoData.lat = position.coords.latitude;
    this.geoData.lng = position.coords.longitude;

    if(typeof this.callbacks.locationUpdate === 'function') {
      this.callbacks.locationUpdate(this.geoData.lat, this.geoData.lng);
    }
